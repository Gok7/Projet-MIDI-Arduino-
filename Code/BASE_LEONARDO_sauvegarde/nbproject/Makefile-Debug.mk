...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_sauvegarde.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_sauvegarde.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_sauvegarde ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/main-BASE-LEONARDO.o: main-BASE-LEONARDO.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main-BASE-LEONARDO.o main-BASE-LEONARDO.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_sauvegarde.exe
