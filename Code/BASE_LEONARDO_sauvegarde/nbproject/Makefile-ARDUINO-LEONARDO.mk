...
${OBJECTDIR}/main-BASE-LEONARDO.o: main-BASE-LEONARDO.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -DARDUINO=155 -DARDUINO_ARCH_AVR -DARDUINO_AVR_LEONARDO -DF_CPU=16000000L -DUSB_PID=0x8036 -DUSB_PRODUCT=\"Arduino\ Leonardo\" -DUSB_VID=0x2341 -IArduino/avr/cores/arduino -IArduino/avr/variants/yun -IArduino/avr/cores/arduino/avr-libc -IArduino/avr/libraries/SPI -IArduino/libraries/TFT/src -IArduino/libraries/SD/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main-BASE-LEONARDO.o main-BASE-LEONARDO.cpp
