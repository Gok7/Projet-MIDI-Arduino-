...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_sauvegarde.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_sauvegarde ${OBJECTFILES} ${LDLIBSOPTIONS} -Os -Wl,--gc-sections -mmcu=atmega32u4 -L ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/FINAL.tmp -lm
