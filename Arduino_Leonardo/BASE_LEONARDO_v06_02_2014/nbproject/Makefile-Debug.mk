...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_v06_02_2014.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_v06_02_2014.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_v06_02_2014 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Arduino/avr/cores/arduino/CDC.o: Arduino/avr/cores/arduino/CDC.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/CDC.o Arduino/avr/cores/arduino/CDC.cpp

${OBJECTDIR}/Arduino/avr/cores/arduino/HID.o: Arduino/avr/cores/arduino/HID.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/HID.o Arduino/avr/cores/arduino/HID.cpp

${OBJECTDIR}/Arduino/avr/cores/arduino/HardwareSerial.o: Arduino/avr/cores/arduino/HardwareSerial.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/HardwareSerial.o Arduino/avr/cores/arduino/HardwareSerial.cpp

${OBJECTDIR}/Arduino/avr/cores/arduino/IPAddress.o: Arduino/avr/cores/arduino/IPAddress.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/IPAddress.o Arduino/avr/cores/arduino/IPAddress.cpp

${OBJECTDIR}/Arduino/avr/cores/arduino/Print.o: Arduino/avr/cores/arduino/Print.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/Print.o Arduino/avr/cores/arduino/Print.cpp

${OBJECTDIR}/Arduino/avr/cores/arduino/Stream.o: Arduino/avr/cores/arduino/Stream.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/Stream.o Arduino/avr/cores/arduino/Stream.cpp

${OBJECTDIR}/Arduino/avr/cores/arduino/Tone.o: Arduino/avr/cores/arduino/Tone.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/Tone.o Arduino/avr/cores/arduino/Tone.cpp

${OBJECTDIR}/Arduino/avr/cores/arduino/USBCore.o: Arduino/avr/cores/arduino/USBCore.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/USBCore.o Arduino/avr/cores/arduino/USBCore.cpp
...
${OBJECTDIR}/Arduino/avr/cores/arduino/WMath.o: Arduino/avr/cores/arduino/WMath.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/WMath.o Arduino/avr/cores/arduino/WMath.cpp
...
${OBJECTDIR}/Arduino/avr/cores/arduino/hooks.o: Arduino/avr/cores/arduino/hooks.c 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -g -IC/Arduino/hardware/tools/avr/avr/include -IC/Arduino/hardware/arduino/avr/cores/arduino -IC/Arduino/hardware/arduino/avr/variants/yun -IC/Arduino/hardware/arduino/avr/cores/arduino/avr-libc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/hooks.o Arduino/avr/cores/arduino/hooks.c

${OBJECTDIR}/Arduino/avr/cores/arduino/new.o: Arduino/avr/cores/arduino/new.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/new.o Arduino/avr/cores/arduino/new.cpp

${OBJECTDIR}/Arduino/avr/cores/arduino/wiring.o: Arduino/avr/cores/arduino/wiring.c 
	${MKDIR} -p ${OBJECTDIR}/Arduino/avr/cores/arduino
	${RM} "$@.d"
	$(COMPILE.c) -g -IC/Arduino/hardware/tools/avr/avr/include -IC/Arduino/hardware/arduino/avr/cores/arduino -IC/Arduino/hardware/arduino/avr/variants/yun -IC/Arduino/hardware/arduino/avr/cores/arduino/avr-libc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/cores/arduino/wiring.o Arduino/avr/cores/arduino/wiring.c
...
${OBJECTDIR}/Arduino/avr/libraries/SPI/SPI.o: Arduino/avr/libraries/SPI/SPI.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/avr/libraries/SPI/SPI.o Arduino/avr/libraries/SPI/SPI.cpp

${OBJECTDIR}/Arduino/libraries/SD/src/SD.o: Arduino/libraries/SD/src/SD.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/libraries/SD/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/libraries/SD/src/SD.o Arduino/libraries/SD/src/SD.cpp
...
${OBJECTDIR}/Arduino/libraries/SD/src/utility/Sd2Card.o: Arduino/libraries/SD/src/utility/Sd2Card.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/libraries/SD/src/utility/Sd2Card.o Arduino/libraries/SD/src/utility/Sd2Card.cpp

${OBJECTDIR}/Arduino/libraries/SD/src/utility/SdFile.o: Arduino/libraries/SD/src/utility/SdFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/libraries/SD/src/utility
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/libraries/SD/src/utility/SdFile.o Arduino/libraries/SD/src/utility/SdFile.cpp

${OBJECTDIR}/Arduino/libraries/SD/src/utility/SdVolume.o: Arduino/libraries/SD/src/utility/SdVolume.cpp 
	${MKDIR} -p ${OBJECTDIR}/Arduino/libraries/SD/src/utility
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arduino/libraries/SD/src/utility/SdVolume.o Arduino/libraries/SD/src/utility/SdVolume.cpp
...
${OBJECTDIR}/C_AFFICHEUR.o: C_AFFICHEUR.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_AFFICHEUR.o C_AFFICHEUR.cpp

${OBJECTDIR}/C_BARRE.o: C_BARRE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_BARRE.o C_BARRE.cpp

${OBJECTDIR}/C_COMMANDE_MIDI.o: C_COMMANDE_MIDI.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_COMMANDE_MIDI.o C_COMMANDE_MIDI.cpp

${OBJECTDIR}/C_CONTROLE.o: C_CONTROLE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_CONTROLE.o C_CONTROLE.cpp

${OBJECTDIR}/C_LISTE_COMMANDES.o: C_LISTE_COMMANDES.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_LISTE_COMMANDES.o C_LISTE_COMMANDES.cpp
...
${OBJECTDIR}/T_MESSAGE.o: T_MESSAGE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/T_MESSAGE.o T_MESSAGE.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo_v06_02_2014.exe
