...
${OBJECTDIR}/C_EEPROM.o: C_EEPROM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DARDUINO=155 -DARDUINO_ARCH_AVR -DARDUINO_AVR_YUN -DF_CPU=16000000L -DUSB_MANUFACTURER= -DUSB_PID=0x8041 -DUSB_PRODUCT=\"Arduino\ Yun\" -DUSB_VID=0x2341 -IC/Arduino/hardware/tools/avr/avr/include -IC/Arduino/hardware/arduino/avr/cores/arduino -IC/Arduino/hardware/arduino/avr/variants/yun -IC/Arduino/hardware/arduino/avr/cores/arduino/avr-libc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_EEPROM.o C_EEPROM.cpp
...
${OBJECTDIR}/C_SERIE.o: C_SERIE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DARDUINO=155 -DARDUINO_ARCH_AVR -DARDUINO_AVR_YUN -DF_CPU=16000000L -DUSB_MANUFACTURER= -DUSB_PID=0x8041 -DUSB_PRODUCT=\"Arduino\ Yun\" -DUSB_VID=0x2341 -IC/Arduino/hardware/tools/avr/avr/include -IC/Arduino/hardware/arduino/avr/cores/arduino -IC/Arduino/hardware/arduino/avr/variants/yun -IC/Arduino/hardware/arduino/avr/cores/arduino/avr-libc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_SERIE.o C_SERIE.cpp

${OBJECTDIR}/EEPROM.o: EEPROM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DARDUINO=155 -DARDUINO_ARCH_AVR -DARDUINO_AVR_YUN -DF_CPU=16000000L -DUSB_MANUFACTURER= -DUSB_PID=0x8041 -DUSB_PRODUCT=\"Arduino\ Yun\" -DUSB_VID=0x2341 -IC/Arduino/hardware/tools/avr/avr/include -IC/Arduino/hardware/arduino/avr/cores/arduino -IC/Arduino/hardware/arduino/avr/variants/yun -IC/Arduino/hardware/arduino/avr/cores/arduino/avr-libc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EEPROM.o EEPROM.cpp

${OBJECTDIR}/LiquidCrystal.o: LiquidCrystal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DARDUINO=155 -DARDUINO_ARCH_AVR -DARDUINO_AVR_YUN -DF_CPU=16000000L -DUSB_MANUFACTURER= -DUSB_PID=0x8041 -DUSB_PRODUCT=\"Arduino\ Yun\" -DUSB_VID=0x2341 -IC/Arduino/hardware/tools/avr/avr/include -IC/Arduino/hardware/arduino/avr/cores/arduino -IC/Arduino/hardware/arduino/avr/variants/yun -IC/Arduino/hardware/arduino/avr/cores/arduino/avr-libc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LiquidCrystal.o LiquidCrystal.cpp
