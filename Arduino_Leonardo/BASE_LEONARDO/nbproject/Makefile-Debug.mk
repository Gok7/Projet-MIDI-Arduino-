...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base_leonardo ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/C_EEPROM.o: C_EEPROM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_EEPROM.o C_EEPROM.cpp
...
${OBJECTDIR}/C_SERIE.o: C_SERIE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C_SERIE.o C_SERIE.cpp

${OBJECTDIR}/EEPROM.o: EEPROM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EEPROM.o EEPROM.cpp

${OBJECTDIR}/LiquidCrystal.o: LiquidCrystal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LiquidCrystal.o LiquidCrystal.cpp
