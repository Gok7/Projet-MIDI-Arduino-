...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/due_projet_v29_01_2014.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/due_projet_v29_01_2014 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/arduino/sam/cores/C_AFFICHEUR.o: arduino/sam/cores/C_AFFICHEUR.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arduino/sam/cores/C_AFFICHEUR.o arduino/sam/cores/C_AFFICHEUR.cpp

${OBJECTDIR}/arduino/sam/cores/C_BARRE.o: arduino/sam/cores/C_BARRE.cpp 
	${MKDIR} -p ${OBJECTDIR}/arduino/sam/cores
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arduino/sam/cores/C_BARRE.o arduino/sam/cores/C_BARRE.cpp
