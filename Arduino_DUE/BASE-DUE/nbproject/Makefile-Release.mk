...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base-due.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base-due.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base-due ${OBJECTFILES} ${LDLIBSOPTIONS} -Os -Wl,--gc-sections -mmcu=atmega32u4 -L ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/FINAL.tmp -lm
...
${OBJECTDIR}/main-BASE-DUE.o: main-BASE-DUE.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DARDUINO=155 -DARDUINO_ARCH_AVR -DARDUINO_AVR_YUN -DF_CPU=16000000L -DUSB_MANUFACTURER= -DUSB_PID=0x8041 -DUSB_PRODUCT=\"Arduino\ Yun\" -DUSB_VID=0x2341 -IC/Arduino/hardware/tools/avr/avr/include -IC/Arduino/hardware/arduino/avr/cores/arduino -IC/Arduino/hardware/arduino/avr/variants/yun -IC/Arduino/hardware/arduino/avr/cores/arduino/avr-libc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main-BASE-DUE.o main-BASE-DUE.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/base-due.exe
