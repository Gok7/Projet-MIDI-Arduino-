...
function ssoGenerateLogoutBar($username) {
  ...
  $r += '<div class="li sep">|</div> ';
  	  $r += '<div class="li up"><a class="t0" href="http://id.arduino.cc/">Profile</a></div> ';
	  $r += '<div class="li sep">|</div> ';
	    $r += '<div class="li"><a href="http://id.arduino.cc/auth/logout/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2F">Sign out</a></div>';
  document.getElementById("loginInfo").innerHTML = $r; 
}

// create the login bar
function ssoGenerateLoginBar() {
  $r = '<div class="lo"><a href="http://id.arduino.cc//auth/login/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2FTutorial%2FLiquidCrystal">Sign in</a> or ';
  $r += '<a href="http://id.arduino.cc/auth/register/?returnurl=http%3A%2F%2Farduino.cc%2Fen%2FTutorial%2FLiquidCrystal">Register</a></div>';
  document.getElementById("loginInfo").innerHTML = $r;
}
...
function ssoGenerateNavigationBar($username) {
  $r = '';
    ...
    $r += '<a class="t0" href="http://playground.arduino.cc/">Playground</a> ';
    $r += '<a class="t0" href="http://forum.arduino.cc/">Forum</a> ';
